package com.exciting.webapp.common.util.banner;
...
public class ImageProcesser {
    ...
    public static void changeImgFile(String path, String tragetfile){
        ...
        processer.toBitmapConvert(srcfolder);
        processer.saveAsTxt(tragetfile);
        System.out.println(srcfolder.getName()+" is converted!");
        System.out.println("All img were converted!");
